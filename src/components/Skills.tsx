  ...
  return (
    <section id="skills" className="py-24 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 px-4">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-4xl font-bold text-center mb-12">技能專區</h2>
              ...
              {skillList.map((skill, idx) => {
                ...
                return (
                  <div
                    ...
                    className="bg-white rounded-lg shadow-md p-6 flex flex-col items-center text-center hover:scale-105 transition-transform"
                  >
                    <div className="mb-4">{skill.icon}</div>
                    <h4 className="text-xl font-semibold">{skill.name}</h4>
                    <p className="text-gray-500 mb-2">{skill.level}</p>

                    {/* 進度條 */}
                    <div className="w-full bg-gray-200 rounded-full h-3">
                      <div
                        className={`h-3 rounded-full transition-all duration-1000 bg-gradient-to-r from-blue-400 to-blue-600`}
